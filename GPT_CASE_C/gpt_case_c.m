...
% In this section you may modify the mesh in any way whatsoever.
    if (Steps(m)==0) && m.globalDynamicProps.doinit % First iteration
        ...
        m.userdata.ranges.modelname.range = { 'CASE_C' };  % CLUSTER
...
%     % like.  For example:
    ...
    if f_initialising
        ...
        m=leaf_setproperty(m,'mingradient',10); % i.e. threshold for using polariser gradient increases when growing
   end

    switch modelname
        case 'CASE_C'  % @@model MODEL1
